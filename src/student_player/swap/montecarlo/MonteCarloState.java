...
public class MonteCarloState {
    ...
    ArrayList<MonteCarloState> getAllPossibleStates() {
        ...
        availableMoves.forEach(move -> {
            ...
            int opponent = (newBoard.getTurnPlayer() == 0) ? PentagoBoardState.BLACK: PentagoBoardState.WHITE;
            newState.setPlayerNo(opponent);
    ...
    int getOpponent() {
        return (this.boardState.getTurnPlayer() == 0) ? PentagoBoardState.BLACK: PentagoBoardState.WHITE;
    }
